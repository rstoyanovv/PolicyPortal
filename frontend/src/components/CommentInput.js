        ...
        <form className="w-2/5 mx-auto">
            <div class="mb-4 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-400 dark:border-gray-300">
                <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-400">
                    ...
                    <textarea id="comment" rows="4" class="w-full px-0 text-sm text-gray-500 bg-white border-0 dark:bg-gray-400 dark:text-black dark:placeholder-black" placeholder="Write a comment..." required></textarea>
                </div>
