    ...
    return (
        <div className="bg-gray-200 article-screen">
            ...
            <form className="comment-section">
                <div class="w-full sm:w-1/2 md:w-1/3 mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-500 dark:border-gray-300">
                    <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-400">
                        <label for="comment" class="sr-only">Your comment</label>
                        <textarea id="comment" rows="4" class="w-full px-0 text-sm text-gray-500 bg-white border-0 dark:bg-gray-400 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a comment..." required></textarea>
                    </div>
                    <div class="flex items-center justify-between px-3 py-2 border-t dark:bg-sky-900">
