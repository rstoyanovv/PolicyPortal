...
export default function AboutScreen() {
    return (
        <div style={{ margin: '3rem 8.5rem' }} className='text-gray-700'>
            ...
            <h2>Our Values</h2>
            <ul class="max-w-ld space-y-1 list-disc list-inside">
                <li><strong>Unbiased Reporting:</strong> We are committed to providing unbiased and fact-based reporting. Our analysis is free from partisan influence, allowing readers to form their own opinions.</li>
            ...
            <ul class="max-w-ld space-y-1 list-disc list-inside">
                <li style={{marginTop: '0.8rem'}}><strong>National Politics:</strong> In-depth analysis of national policies, elections, and government decisions.</li>
